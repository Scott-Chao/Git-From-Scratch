...
class GitRepository(object):
    ...
    def flat_tree(self, ref: str, prefix: str = "") -> Dict[str, str]:
        ...
        for leaf in tree.items:
            ...
            if is_subtree:
                ret.update(self.flat_tree(leaf.sha, full_path))
            else:
    ...
    def write(self, repo: GitRepository) -> None:
        ...
        with open(index_file, "wb") as f:
            ...
            for e in self.entries:
                ...
                f.write(
                    (flag_assume_valid | e.flag_stage | name_length).to_bytes(2, "big")
                )
...
class GitIgnore(object):
    ...
    def build(cls, repo: GitRepository) -> GitIgnore:
        ...
        if os.path.exists(repo_file):
            with open(repo_file, "r") as f:
                ret.absolute.append(GitIgnore._parse_lines(f.readlines()))
    ...
    def is_ignored(self, path: str) -> bool:
        ...
        result = self._check_scoped(path)
